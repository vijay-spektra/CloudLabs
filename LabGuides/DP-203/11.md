...
```
https://cloud.oracle.com/?tenant=<inject key="azureaduseremail"/>&domain=<inject key="labvm Admin Username"/>&amp;region=<inject key="region"/>
```
...
<br/>
Default Dummy Value + Value : <inject key="email" defaultValue="example@example.com" value="-appended"/>
<br/>
Default Actual Value + Value : <inject key="azureaduseremail" defaultValue="example@example.com" value="-appended"/>
