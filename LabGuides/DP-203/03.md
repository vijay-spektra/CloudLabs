...
```
docker build src -f ./src/ContosoTraders. Api.Carts/Dockerfile -t contosotradersacr<inject_key="AzureAdUserEmail"></inject>.azurecr.io/contosotradersapicarts:latest -t
